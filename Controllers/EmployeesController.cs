...
namespace TekDesk.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,FName,LName")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,FName,LName")] Employee employee)
        {
            if (id != employee.ID)
            {
                return NotFound();
